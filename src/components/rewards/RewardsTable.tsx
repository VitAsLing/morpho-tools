        ...
        <table className="table-fixed-layout">
          ...
          <tbody>
            {isLoading ? (
              ...
              <tr>
                <td colSpan={5} className="px-4 py-12 !text-center text-[var(--error)]">
              ...
              allRewards.map((reward) => {
                ...
                return (
                  <tr
                    key={`${reward.source}-${reward.tokenAddress}`}
                    className="border-b border-[var(--border)] hover:bg-[var(--bg-tertiary)]"
                  >
                    {/* Source */}
                    <td className="px-4 py-5">
                      <span className="inline-flex items-center gap-2 px-3 py-1 bg-[var(--bg-tertiary)] rounded-full text-sm font-medium text-[var(--text-primary)]">
                    ...
                    <td className="px-4 py-5">
                      <div className="flex flex-col">
                        ...
                        <span className="text-sm text-[var(--text-secondary)]">
                          {formatUsd(claimableNowUsd)}
                        </span>
                      </div>
                    </td>
                    {/* Next Claimable */}
                    <td className="px-4 py-5 text-[var(--text-secondary)] text-base tabular-nums">
                      <div className="flex items-center gap-1">
                        <TokenLogo
                          address={reward.tokenAddress}
                          symbol={reward.tokenSymbol}
                    ...
                    <td className="px-4 py-5">
                      <button
                        ...
                        className={`btn text-base py-2 px-4 ${
                          hasClaimable ? 'btn-primary' : 'btn-secondary opacity-50'
                        }`}
                      >
